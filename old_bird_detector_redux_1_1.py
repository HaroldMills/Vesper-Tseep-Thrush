...
and Bill Evans using the MathWorks' Simulink and Real-Time Workshop. They
were based on an algorithm developed in 1994 by Harold Mills at the
Biocaoustics Research Program of the Cornell Lab of Ornithology. The
